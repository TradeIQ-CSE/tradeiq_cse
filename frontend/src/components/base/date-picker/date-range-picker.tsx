...
export interface DateRangePickerProps {
  ...
  /**
   * Marks individual days with no data (e.g. non-trading days) so they read
   * as unavailable rather than plain out-of-range. Paired with
   * `allowsNonContiguousRanges` below so a range can still span over them —
   * a Mon-Fri pick shouldn't be rejected just because it crosses a weekend.
   */
