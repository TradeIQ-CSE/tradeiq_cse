 ...
 * gets `role="alert"` and the warning-free error treatment.
 */
...
export function ResultBanner({ outcome }: ResultBannerProps) {
  ...
  if (outcome.kind === 'error') {
    return (
      <div className="order-ticket__banner order-ticket__banner--error" role="alert">
  ...
  if (outcome.kind === 'filled' && order.fill) {
    return (
      <div className="order-ticket__banner order-ticket__banner--success" role="status">
        <p className="order-ticket__banner-title">
        ...
        <p className="order-ticket__banner-detail">
  ...
  return (
    <div className="order-ticket__banner order-ticket__banner--warning" role="status">
      <p className="order-ticket__banner-title">
      ...
      <p className="order-ticket__banner-note">{t('paperTrading.ticket.result.recorded')}</p>
    </div>
  );
}
