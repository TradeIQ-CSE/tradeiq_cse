                ...
                <li key={row.symbol}>
                  ...
                  >
                    ...
                    <span className="relative flex min-w-0 flex-1 flex-col">
                      ...
                      {/* text-secondary, not the tertiary the plain table
                          uses: this row sits on a tinted gain/loss bar
                          rather than a flat card surface, and tertiary's
                          contrast against that tint is too low, especially
                          in light mode. */}
                    ...
                    <span
                      className={cx(
                        ...
                        positive
                          ? "text-market-gain-text"
                          : "text-market-loss-text",
                      )}
                    >
                      {list === "most_active"
