...
// The same cases identity-auth's guard spec covers. Both services must accept
// and reject exactly the same tokens: a user whose token works on one service
// and not the other is a worse failure than either service being wrong alone.
